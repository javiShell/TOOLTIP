...
app.use(bodyparser.urlencoded(
    ...
    app.post('/login', function (req, res) {
        if (!req.user.NOMBREUSUARIO || !req.user.PASS ) {
          res.send('login failed');
        } else if(req.user.NOMBREUSUARIO === "jose" || req.user.PASS === "hunter2") {
    ...
    app.post('/Addusers', async (req, res) => {
        const {contador=2,NOMBRE="prueba",APELLIDOS,EMAIL,NOMBREUSUARIO="fjp",PASS="fjp" } = req.body;
        
       console.log(req);
        sql = "insert into USUARIOS(ID_USUARIO,NOMBRE,APELLIDOS,EMAIL,NOMBREUSUARIO,PASS) values (:contador,:NOMBRE,:APELLIDOS,:EMAIL,:NOMBREUSUARIO,:PASS)";
    
        await BD.Open(sql, [contador,NOMBRE,APELLIDOS,EMAIL,NOMBREUSUARIO,PASS], true);
        contador++;
        res.status(200).json({
            "username": username,
            "firstname": firstname,
